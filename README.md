...
##### Windows
On Windows, you'll be looking for `sqlite3.dll` instead of `libsqlite3.so`, be
careful to also use `/` in the path you specify (Windows's paths usually use
`\`).
You can get sqlite3 precompiled binaries for Windows
